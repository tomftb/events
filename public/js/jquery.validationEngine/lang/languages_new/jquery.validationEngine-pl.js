    ...
    $.validationEngineLanguage = {
        newLang: function(){
	     ...
	     "groupRequired": {
                ...
                "future": {
                    "regex": "none",
                    "alertText": "* Data musi być równa lub późniejsza niż "
                },	
                "maxCheckbox": {
                    "regex": "none",
                ...
                "email_seria": {
                    // Shamelessly lifted from Scott Gonzalez via the Bassistance Validation plugin http://projects.scottsplayground.com/email_address_validation/
                    "regex": /^[a-z][\.a-z0-9_-]*@[a-z0-9][a-z0-9_-]*(\.[a-z0-9_-][a-z0-9_-]*)*( [a-z][\.a-z0-9_-]*@[a-z0-9][a-z0-9_-]*(\.[a-z0-9_-][a-z0-9_-]*)*)*$/i,
                    "alertText": "* Nieprawidłowy/e adres e-mail (adresy rozdzielone spacjami)"
                },
